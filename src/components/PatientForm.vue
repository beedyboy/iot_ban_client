  ...
  <div class="form-container">
    <form class="form-page" @submit="submit">
      <div class="form-control">
        ...
        <input v-model="heart_rate" type="text" name="text" />
      </div>
      <div class="form-control">
        <label> Blood Pressure </label>
        <input v-model="blood_pressure" type="text" name="Last" />
      </div>
      <div class="form-control">
        <label>Temperature </label>
        <input v-model="temperature" type="text" name="text" />
      </div>
      <div class="form-control">
        <label> Glucose </label>
        <input v-model="glucose_level" type="text" name="glucose" />
      </div>
      <div class="form-control">
        <label> Saturation / Blood Level </label>
        <input v-model="saturation" type="text" name="saturation" />
      </div>
      <div class="form-control">
        <label> Pulse Rate </label>
        <input v-model="pulse_rate" type="text" name="pulse" />
      </div>
      <div class="form-control">
        <label> Respiratory Rate </label>
        <input v-model="respiratory" type="text" name="respiratory" />
      </div>
